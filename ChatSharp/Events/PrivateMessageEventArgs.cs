...
namespace ChatSharp.Events
{
    ...
    public class PrivateMessageEventArgs : EventArgs
    {
        ...
        internal PrivateMessageEventArgs(IrcClient client, IrcMessage ircMessage, ServerInfo serverInfo, bool action)
        {
            IrcMessage = ircMessage;
            PrivateMessage = new PrivateMessage(client, IrcMessage, serverInfo, action);
        }
    }
}
